...
import warnings
import random
from datasets.loading_data import loading_data, loading_data_train
...
# get the dataset
def prepare_dataset(args, is_train=False):
    if is_train:
        return loading_data_train(args)
...
def main(args):
    ...
    train_loader, val_loader = prepare_dataset(args, True)
